    ...
    <div className="presignup-container">
      ...
      <style>
        ...
        .presignup-container {
          ...
          background: radial-gradient(600px circle at 20% 80%, rgba(100,120,220,0.05) 0%, transparent 80%),
                      radial-gradient(600px circle at 80% 20%, rgba(100,120,220,0.05) 0%, transparent 80%),
                      repeating-radial-gradient(
                        circle at center,
                        rgba(100,120,220,0.03) 0px,
                        rgba(100,120,220,0.03) 1px,
                        transparent 1px,
                        transparent 150px
                      );
