...
const Gantt = () => {
  ...
  const [tasks, setTasks] = useState({
    data: [
      // Adjusted initial data to include startDate and dueDate strings
      // GanttComp will convert these to Date objects and calculate duration on parse
      // Added end_date for initial data consistency with the new save logic
      { id: 2, text: 'Task #1', start_date: new Date('2025-04-02'), end_date: new Date('2025-04-10'), duration: 8, progress: 0.6, parent: null,
        description: "First task description", assignedTo: ["user-1", "user-3"], priority: '!!', tag: 'Development',
        // Store date strings for popup
        startDate: '2025-04-02', dueDate: '2025-04-09' // Note: dueDate string is usually the last day of the task
      },
      { id: 3, text: 'Task #2', start_date: new Date('2025-04-11'), end_date: new Date('2025-04-19'), duration: 8, progress: 0.6, parent: null,
        description: "Second task description", assignedTo: ["user-2"], priority: '!', tag: 'Design',
        // Store date strings for popup
        startDate: '2025-04-11', dueDate: '2025-04-18' // Note: dueDate string is usually the last day of the task
      }
    ],
    links: [
      // Links might need adjustment if the parent structure changes significantly
      // { id: 1, source: 2, target: 3, type: '0' }, // Link between Task 1 and Task 2
    ]
  });
