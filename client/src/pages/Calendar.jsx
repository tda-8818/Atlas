...
// Sample team members data (should be the same as in Kanban)
const teamMembers = [
...
// Sample initial events (can be empty if you want to start with a clean calendar)
const initialEvents = [
  {
    id: 'event-1',
  ...
  },
  {
    ...
    start: new Date(new Date().setDate(new Date().getDate() + 1)), // Tomorrow all day
    allDay: true,
    extendedProps: {
